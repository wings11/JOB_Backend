...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query(
      "INSERT INTO jobs (title, company, type, line_id, salary_range, details, employer_id) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *",
...
router.put("/:id", async (req, res) => {
  ...
  try {
    ...
    if (decoded.role !== "admin" && job.rows[0].employer_id !== decoded.id) {
